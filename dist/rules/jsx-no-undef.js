                ...
                if (autoImport && missingComponents.length) {
                    ...
                    if (importNode) {
                        context.report({
                            ...
                            fix: (fixer) => {
                                return (0, utils_2.appendImports)(fixer, context.sourceCode, importNode, missingComponents);
                            },
                        });
                    }
                    else {
                        context.report({
                            ...
                            fix: (fixer) => {
                                return (0, utils_2.insertImports)(fixer, context.sourceCode, "solid-js", missingComponents);
                            },
                        });
                    }
                }
