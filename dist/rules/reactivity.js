...
class ScopeStack extends Array {
  ...
  *consumeReferencesInScope(variables) {
  ...
  isReferenceInCurrentScope(reference) {
    let parentFunction = (0, utils_2.findParent)(
      reference.identifier,
      utils_2.isProgramOrFunctionNode,
    );
...
exports.default = createRule({
  ...
  create(context, [options]) {
    ...
    const onFunctionExit = (currentScopeNode) => {
      ...
      if (
        (0, utils_2.isFunctionNode)(currentScopeNode) &&
      ...
      for (const { reference, declarationScope } of scopeStack.consumeSignalReferencesInScope()) {
        ...
        if (reference.isWrite()) {
          ...
          if (
            ...
            if (
              (0, utils_2.isJSXElementOrFragment)(elementOrAttribute) ||
    ...
    const checkForTrackedScopes = (node) => {
      ...
      const permissivelyTrackNode = (node) => {
        (0, estraverse_1.traverse)(node, {
          enter(cn) {
            const childNode = cn;
            const traced = (0, utils_2.trace)(childNode, context.sourceCode.getScope(node));
            if (
      ...
      if (node.type === "JSXExpressionContainer") {
        if (
          ...
          (0, utils_2.isJSXElementOrFragment)(node.parent) &&
          (0, utils_2.isFunctionNode)(node.expression)
        ) {
            ...
            if (arg1) {
              ...
              if (owner) {
                ...
                if (
                  ...
                  const ownerFunction = (0, utils_2.findParent)(
                    decl.node,
                    utils_2.isProgramOrFunctionNode,
                  );
